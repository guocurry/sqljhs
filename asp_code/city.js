...
cityareacode[0]=new Array('东城区','西城区','崇文区','宣武区','朝阳区','海淀区','丰台区','石景山','昌平区');
cityareaname[0]=new Array('东城区','西城区','崇文区','宣武区','朝阳区','海淀区','丰台区','石景山','昌平区');
if (selectP=='02')
...
if (selectP=='35')
{ a=35;tempoption=new Option('台湾','澳门',false,true); }
else
{ tempoption=new Option('台湾','澳门'); }
