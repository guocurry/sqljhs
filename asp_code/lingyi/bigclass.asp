...
rs.open "select * from big_proclass order by id desc",conn,1,1
...
%>
    ...
    <td>&nbsp;</td>
    <td><a href="bigclass_add.asp?id=<%=rs(0)%>"><img src="images/t02.png" /></a></td>
    </tr>
<%rs.movenext 
i=i+1 
j=j-1
...
dim sql
sql="delete from [big_proclass] where id in ("&Request.Form("id")&")"
conn.Execute ( sql )
Response.Write("<script>alert(""删除成功！"");javascript:window.location.href='bigclass.asp';</script>")
else
